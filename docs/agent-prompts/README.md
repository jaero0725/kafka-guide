...
| 1 | `wave1-content.md` | 8 | **병렬** — 한 메시지에 8개 Agent 호출 |
| 2 | `wave2-questions.md` | 6 | **병렬** — 한 메시지에 6개 Agent 호출 |
| 3 | `wave3-verify.md` | 4 | **병렬** — 읽기 전용 검증, 리포트 반환 |
| — | (수정 적용) | 1 | Wave 3 리포트 기반 수정. 필요 시 해당 에이전트 재실행 |
| 4 | `wave4-integration.md` | 1 | **동기 단독** — 인덱스 생성·최종 통합 |
...
5. docs/QUESTION_SCHEMA.md        — 문제 JSON 스키마 (문제 생성 에이전트만)
